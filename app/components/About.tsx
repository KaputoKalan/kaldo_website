...
const About = () => {
	return (
		<section
			id="about"
			className="gap-16 p-10  md:py-10 md:h-full  mt-0 md:mt-20 ">
			<div className="mx-auto md:w-5/6 flex flex-col md:flex-row md:h-full gap-5">
				{/* left */}
				<div className="basis-1/2">
					...
					<div className="border border-1 border-gray-200 rounded-2xl mt-16 flex items-center justify-center w-full  md:w-[400px] p-10 ">
