...
const Testimonials = () => {
	return (
		<section className="gap-16  md:py-10 md:h-[60vh]  mt-0 md:my-20  ">
			<div className="md:mx-auto md:w-3/6 flex flex-col md:h-full gap-5">
				...
				<div className="flex gap-5  ">
					...
					<div className="bg-primary-500 p-10 rounded-xl flex justify-between items-center flex-col basis-1/3 w-[60px] ">
