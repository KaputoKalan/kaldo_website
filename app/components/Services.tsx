...
const Services = () => {
	return (
		<section id="services" className="gap-16  py-10 h-full mt-10 ">
			<div className="mx-auto py-20 w-full sm:w-5/6 bg-black text-white sm:rounded-xl flex flex-col items-center justify-center ">
				<p className="py-5 text-gray-500 font-bold text-xs md:text-sm">
					OUR SERVICES
				</p>
				<h2 className=" text-xl sm:text-4xl font-black text-center p-2 sm:p-0 w-full sm:w-3/6 ">
