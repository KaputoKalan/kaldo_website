...
const Navigation = ({ PageDisplays }) => {
  ...
  return (
    <div className=" lg:bg-Magnolia lg:flex lg:flex-col lg:items-center lg:justify-center lg:h-screen">
      <div className="lg:w-[58.563rem] lg:h-[37.5rem] lg:flex lg:flex-col lg:items-center lg:justify-center">
        <div className=" lg:bg-White w-full h-screen lg:flex lg:flex-row lg:justify-center lg:items-center lg:w-[56.75rem] lg:h-[35.563rem] lg:shadow-2xl">
            ...
            <div className="lg:flex lg:items-center lg:gap-4">
              <p
                className={classNames(
                  ' duration-300 w-8 h-8 flex items-center justify-center rounded-full border-solid border-White border-2',
          ...
          <div className=" text-base absolute font-ubuntu  translate-y-[-5rem] w-[80%] h-[23.438rem] flex flex-col items-center lg:relative lg:translate-y-0 lg:h-full">
            {PageDisplays()}
          </div>
        </div>
      </div>
