    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-3 w-full lg:px-12 lg:grid lg:grid-cols-3 lg:gap-8">
          ...
          <div className=" h-12 flex flex-row items-center justify-center gap-6 bg-Magnolia rounded-md lg:col-span-3">
            ...
            <label
              htmlFor="check"
              className=" h-5 w-9 rounded-full bg-Marineblue cursor-pointer relative"
            >
              <input
                type="checkbox"
                id="check"
      ...
      <div className="bottom-0 translate-y-[8rem]  w-full px-4 flex flex-row items-center justify-cente h-[4.5rem] cursor-pointer lg:translate-y-0 lg:relative  lg:bg-none lg:w-full lg:pb-8 lg:px-24">
        <div className=" my-6 flex items-center  w-full justify-between">
          <button className=" text-Coolgray " onClick={HandlePrev}>
            Go back
          </button>
          <button
            className=" font-ubuntu  font-bold bg-Marineblue h-10 w-24 text-White flex items-center justify-center rounded hover:bg-Purplishblue duration-300  lg:mr-0"
            onClick={HandleNext}
          >
            Next Step
          </button>
